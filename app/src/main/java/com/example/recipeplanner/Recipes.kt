...
val seedRecipes = mutableListOf(
     ...
     Recipes("Chicken Quesadilla", 10,20,
         ...
         listOf("Preheat a skillet with oil on medium high. Add in chicken and taco seasoning. Cook for 4 minutes",
     ...
     Recipes("Cake Pops", 60,120,
         listOf("1 box vanilla cake mix",
             ...
             "40 cake pop sticks",
             "1 pack sprinkles"),
         listOf("Make boxed cake mix as directed on box. Before mixing all ingredients, add in the vegetable oil.",
     ...
     Recipes("Caesar Salad", 10, 20,
         listOf("3 cups torn sourdough bread (1/2 inch pieces)",
         ...
         listOf("Prepare croutons: Arrange a rack in center of oven; preheat to 375°. In a large bowl, toss bread pieces, oil, salt, and pepper. Spread bread pieces on a baking sheet.",
         ...
         4, "Lunch", R.drawable.caesarsalad),

     Recipes("Pinwheel Sandwiches", 10, 25,
         listOf("3/4 cup mayonnaise",
         ...
         listOf("In a small bowl, mix mayonnaise and ranch seasoning.",
         ...
         40, "Lunch", R.drawable.pinwheels),

     Recipes("Steak Fajita Power Bowls", 30, 45,
        listOf("2 Tbsp. vegetable oil, divided",
        ...
        listOf("In a large skillet over medium heat, heat 1 Tbsp. oil. Add onions and peppers; season with salt and pepper. Cook, stirring frequently, until onions are translucent and peppers are tender, 7 to 10 minutes. Transfer to a plate.",
        ...
        4, "Lunch", R.drawable.steakfajitapowerbowls),
     Recipes("Crispy Sheet-Pan Black Bean Tacos", 5, 45,
         listOf("5 Tbsp. neutral oil, divided",
         ...
         listOf("Place a rack in center of oven; preheat to 425°. In a large skillet over medium heat, heat 2 tablespoons oil. Add onion, season with 1/2 teaspoon salt, and cook, stirring occasionally, until softened and sweet to the taste, about 7 minutes. Add taco seasoning and 1 tablespoon oil and cook, stirring, until fragrant, about 30 seconds.",
         ...
         4, "Lunch", R.drawable.sheetpanbeantacos),
     Recipes("Buffalo Chicken Grilled Cheese", 10, 10,
         listOf("2 cups rotisserie chicken, shredded",
             "1 block cream cheese, softened",
             "1/2 cup buffalo sauce",
             "1/2 cup shredded sharp white cheddar (or Monterey Jack)",
             "2 Tbsp. butter",
             "4 slices bread"),
         listOf("In a large mixing bowl, combine chicken, cream cheese, buffalo sauce, and white cheddar. Slather on bread and form sandwiches, then set aside.",
         ...
         2, "Lunch", R.drawable.buffalochickengrilledcheese),
     Recipes("Taco Salad", 15, 35,
         listOf("1 lb. ground beef",
             ...
             "1/2 cup sour cream"),
         listOf("In a large cast-iron skillet over medium-high heat, cook beef, breaking up into small pieces with a wooden spoon; season with salt and pepper. Add taco seasoning, tomato paste, and 2 Tbsp. water. Cook, stirring occasionally, until beef is browned and cooked through, about 5 minutes. Remove from heat.",
         ...
         4, "Lunch", R.drawable.tacosalad),
     Recipes("Tuscan Chicken Wrap", 15, 20,
         listOf("6 Tbsp. mayonnaise",
         ...
         listOf("In a small bowl, mix mayonnaise, basil, sun-dried tomatoes, Parmesan, oregano, scallion, and garlic until combined.",
         ...
         4, "Lunch", R.drawable.tuscanchickenwrap),
     Recipes("Deviled Eggs", 10, 25,
         listOf("6 large eggs",
         ...
         listOf("Place the eggs in a medium pot and cover with cold water by 1 inch. Bring to a boil, then cover the pot and turn off the heat. Let the eggs sit, covered, for 10 to 12 minutes, depending on your desired doneness.",
         ...
         6, "Appetizer", R.drawable.deviledeggs),
     Recipes("Seafood Stuffed Mushrooms", 20, 30,
         listOf("12 oz bag Italian Stuffing mix",
         ...
         listOf("Pre-heat oven to 350F. Wash and separate stems from mushroom caps, save about 8 stems to chop and set aside.",
         ...
         12, "Appetizer", R.drawable.stuffedmushrooms),
     Recipes("Caprese Skewers", 15, 15,
         listOf("24 cherry tomatoes",
                 "12 mini mozzarella balls",
                 "24 basil leaves",
                 "Extra-virgin olive oil, for drizzling",
                 "Balsamic reduction, for drizzling",
                 "Sea salt and freshly ground black pepper"),
         listOf("Thread the tomatoes, mozzarella, and basil onto mini skewers.",
                 "Drizzle with olive oil and balsamic reduction and sprinkle with salt and pepper."),
         4, "Appetizer", R.drawable.capreseskewers),
    Recipes("Jalapeño Poppers", 20, 20,
        listOf("12 jalapeño peppers",
                ...
                "Extra-virgin olive oil, for drizzling"),
        listOf("Preheat the oven to 400°F and line a baking sheet with parchment paper",
        ...
        8, "Appetizer", R.drawable.jalapenopoppers),
    Recipes("Spinach Artichoke Dip", 25, 40,
        listOf("3 cups small cauliflower florets, 3/4-inch pieces",
                "2 garlic cloves",
        ...
        listOf("Preheat the oven to 450°F and brush an 8-inch cast iron skillet lightly with olive oil.",
        ...
        4, "Appetizer", R.drawable.spinachartichokedip)
